...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kmailtransport-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kmailtransport-25.04.2.tar.xz.sig
...
%setup -q -n kmailtransport-25.04.2
cd %{_builddir}/kmailtransport-25.04.2
pushd ..
cp -a kmailtransport-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749521747
mkdir -p clr-build
pushd clr-build
