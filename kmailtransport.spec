...
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/kmailtransport-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/kmailtransport-20.12.1.tar.xz.sig
...
%prep
%setup -q -n kmailtransport-20.12.1
cd %{_builddir}/kmailtransport-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610049254
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmailtransport-20.12.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmailtransport/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kmailtransport-20.12.1/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kmailtransport/6f1f675aa5f6a2bbaa573b8343044b166be28399
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5MailTransport.so.5.16.1
/usr/lib64/libKF5MailTransportAkonadi.so.5
/usr/lib64/libKF5MailTransportAkonadi.so.5.16.1
