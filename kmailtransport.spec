...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kmailtransport-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kmailtransport-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kmailtransport-24.02.0
cd %{_builddir}/kmailtransport-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710421520
mkdir -p clr-build
pushd clr-build
