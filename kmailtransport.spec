...
%prep
%setup -q -n kmailtransport-23.04.1
cd %{_builddir}/kmailtransport-23.04.1
...
/usr/lib64/libKPim5MailTransport.so.5.23.1
/usr/lib64/libKPim5MailTransportAkonadi.so.5
/usr/lib64/libKPim5MailTransportAkonadi.so.5.23.1
