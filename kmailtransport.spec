...
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kmailtransport-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kmailtransport-24.12.2.tar.xz.sig
...
%setup -q -n kmailtransport-24.12.2
cd %{_builddir}/kmailtransport-24.12.2
pushd ..
cp -a kmailtransport-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738984038
mkdir -p clr-build
pushd clr-build
