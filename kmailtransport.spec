...
Version  : 23.08.3
Release  : 66
URL      : https://download.kde.org/stable/release-service/23.08.3/src/kmailtransport-23.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/kmailtransport-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/kmailtransport-23.08.3.tar.xz.sig
...
%prep
%setup -q -n kmailtransport-23.08.3
cd %{_builddir}/kmailtransport-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701997159
mkdir -p clr-build
pushd clr-build
