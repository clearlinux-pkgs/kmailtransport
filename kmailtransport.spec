...
Version  : 23.08.4
Release  : 67
URL      : https://download.kde.org/stable/release-service/23.08.4/src/kmailtransport-23.08.4.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/kmailtransport-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/kmailtransport-23.08.4.tar.xz.sig
...
%prep
%setup -q -n kmailtransport-23.08.4
cd %{_builddir}/kmailtransport-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702985135
mkdir -p clr-build
pushd clr-build
