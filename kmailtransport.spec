...
Source0  : https://download.kde.org/stable/release-service/21.12.1/src/kmailtransport-21.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.1/src/kmailtransport-21.12.1.tar.xz.sig
...
%prep
%setup -q -n kmailtransport-21.12.1
cd %{_builddir}/kmailtransport-21.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641967059
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmailtransport-21.12.1/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kmailtransport/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kmailtransport-21.12.1/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kmailtransport/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kmailtransport-21.12.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmailtransport/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kmailtransport-21.12.1/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kmailtransport/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/kmailtransport-21.12.1/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/kmailtransport/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5MailTransport.so.5.19.1
/usr/lib64/libKF5MailTransportAkonadi.so.5
/usr/lib64/libKF5MailTransportAkonadi.so.5.19.1
