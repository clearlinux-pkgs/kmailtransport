...
Version  : 19.12.3
Release  : 21
URL      : https://download.kde.org/stable/release-service/19.12.3/src/kmailtransport-19.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.3/src/kmailtransport-19.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.3/src/kmailtransport-19.12.3.tar.xz.sig
...
%prep
%setup -q -n kmailtransport-19.12.3
cd %{_builddir}/kmailtransport-19.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583534046
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmailtransport-19.12.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/kmailtransport/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5MailTransport.so.5.13.3
/usr/lib64/libKF5MailTransportAkonadi.so.5
/usr/lib64/libKF5MailTransportAkonadi.so.5.13.3
