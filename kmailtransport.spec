...
Source0  : https://download.kde.org/stable/release-service/20.08.0/src/kmailtransport-20.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.0/src/kmailtransport-20.08.0.tar.xz.sig
...
%prep
%setup -q -n kmailtransport-20.08.0
cd %{_builddir}/kmailtransport-20.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597732703
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmailtransport-20.08.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmailtransport/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kmailtransport-20.08.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kmailtransport/6f1f675aa5f6a2bbaa573b8343044b166be28399
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5MailTransport.so.5.15.0
/usr/lib64/libKF5MailTransportAkonadi.so.5
/usr/lib64/libKF5MailTransportAkonadi.so.5.15.0
